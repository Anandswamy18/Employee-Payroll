        ...
        if (Array.isArray(employeeData)) {
            ...
            employeeData.forEach(data => {
                ...
                newRow.innerHTML = `
                    ...
                    <td>${data.gender}</td>
                    <td><div class="department">${departmentDivs.join('')}</div></td>
                    <td>${data.salary}</td>
                    <td>${data.date}</td>
                    <td class="buttons"><button><i class="fa-solid fa-trash-can-arrow-up" style="color: #658292;"></i></button><button><i class="fa-solid fa-pen" style="color: #658292;"></i></button></td>
                `;
...
addUser.addEventListener('click',()=>{
    window.location.href=('http://127.0.0.1:5500/employee_front.html')
